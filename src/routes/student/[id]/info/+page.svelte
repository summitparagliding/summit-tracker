<script>
  ...
  const guideSections = [
    ...
    { fr:'Étude et Quiz', en:'Study and Quiz',
      fr_body:'L\'onglet Étude contient le Manuel FFVL (défilement continu, mode 2 pages, saut de page) et un quiz de 174 questions classées par catégorie.',
      en_body:'The Study tab contains the FFVL Manual (continuous scroll, 2-page mode, page jump) and a 174-question quiz organised by category.' },
